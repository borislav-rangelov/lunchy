...
export class Menu extends React.Component<IMenuProps, IMenuState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="menu-heading">
          <Translate contentKey="lunchyApp.menu.home.title">Menus</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="lunchyApp.menu.home.createLabel">Create new Menu</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('name')}>
                  <Translate contentKey="lunchyApp.menu.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('validFrom')}>
                  <Translate contentKey="lunchyApp.menu.validFrom">Valid From</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('validTo')}>
                  <Translate contentKey="lunchyApp.menu.validTo">Valid To</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="lunchyApp.menu.restaurant">Restaurant</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {menuList.map((menu, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{menu.name}</td>
                  <td>
                    <TextFormat type="date" value={menu.validFrom} format={APP_DATE_FORMAT} />
                  </td>
                  <td>
                    <TextFormat type="date" value={menu.validTo} format={APP_DATE_FORMAT} />
                  </td>
