    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="lunchyApp.restaurant.home.createOrEditLabel">
              <Translate contentKey="lunchyApp.restaurant.home.createOrEditLabel">Create or edit a Restaurant</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
