    ...
    return (
      <div>
        <h2 id="restaurant-heading">
          <Translate contentKey="lunchyApp.restaurant.home.title">Restaurants</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="lunchyApp.restaurant.home.createLabel">Create new Restaurant</Translate>
          </Link>
        </h2>
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('name')}>
                    <Translate contentKey="lunchyApp.restaurant.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
